...
<body>
    ...
    <div class="content" id="mainContent">
        ...
        <!-- SECCIÓN INICIO - DASHBOARD PRINCIPAL (GRID 20x20) -->
            ...
            <section>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li><?php echo htmlspecialchars($c['alberca']); ?>: Cloro <?php echo $c['cloro_ppm']; ?> ppm | pH <?php echo $c['ph']; ?> | Temperatura <?php echo $c['temperatura']; ?>°C</li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                <div>
            ...
            <section>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li><?php echo htmlspecialchars($p['nombre']); ?> - <?php echo htmlspecialchars($p['turno']); ?> (<?php echo date('g:i A', strtotime($p['hora_inicio'])); ?> - <?php echo date('g:i A', strtotime($p['hora_fin'])); ?>) - Área: <?php echo htmlspecialchars($p['area']); ?></li>
                        <?php endforeach; ?>
                ...
                <div>
                    ...
                    <ul>
                        <?php foreach (($albercas ?? []) as $a): 
                            $porcentaje = $a['capacidad_maxima'] > 0 ? round(($a['aforo_actual'] / $a['capacidad_maxima']) * 100) : 0;
                        ?>
                        <li><?php echo htmlspecialchars($a['nombre']); ?>: <?php echo $a['aforo_actual']; ?>/<?php echo $a['capacidad_maxima']; ?> personas (<?php echo $porcentaje; ?>%)</li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                <div>
